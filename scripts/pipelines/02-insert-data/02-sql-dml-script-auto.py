#!/usr/bin/env python3
"""
Rhythm Site - SQL DML Pipeline
Ejecuta los archivos de INSERT en orden para poblar la base de datos con datos de prueba.
"""
import psycopg2
import sys
import os
...
SQL_FILES = [
    ("08_inserts_datos.sql", "Inserts de datos de prueba", "rhythm_site"),
]
...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Rhythm Site — Pipeline de Inserts")
...
def main():
    ...
    print("=" * 60)
    print("  Rhythm Site — Pipeline DML (Inserts)")
    print("=" * 60)
    ...
    print()
    print("=" * 60)
    print("  Pipeline de inserts completado exitosamente.")
    print("=" * 60)
